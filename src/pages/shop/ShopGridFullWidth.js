// editing code-new ✅ FIXED FULL FILE
...
const ShopGridFullWidth = () => {
        ...
        filtered.forEach((product) => {
          (product.sizes || []).forEach((size) => {
            (size.colors || []).forEach((colorObj) => {
              if (colorObj?.color) colors.add(colorObj.color);
            });
          });
        });
  ...
  useEffect(() => {
    setCurrentPage(1);
    filterProducts();
  }, [selectedSizes, selectedColors, selectedPriceRanges, sortOrder, products]);
          ...
          <div className="container-fluid">
            <div className="row">
              <div className="col-lg-3 order-2 order-lg-1">
                <h4 className="mb-3" style={{ color: "grey" }}>
                  COLORS
                </h4>
                ...
                <h4 className="mt-3 mb-3" style={{ color: "grey" }}>
                  SIZES
                </h4>
                {sizes.map((size, idx) => (
                  <div key={idx} className="mb-2">
