      ...
      <LayoutOne headerTop="visible">
        <Container className="py-5">
          {wishlistItems.length === 0 ? (
            ...
            <>
              <h4 className="mb-4" style={{color:'#000000'}}>My Wishlist ({wishlistItems.length} items)</h4>
              <Row>
                  ...
                  <Col xs={12} sm={6} md={4} lg={3} className="mb-4" key={item.productId._id}>
                    <Card style={{ height: '100%' }} onClick={() => handleCardClick(item.productId._id)} className="ms-3 me-3">
                      ...
                      <Card.Body style={{ height: '100%' }}>
                        ...
                        <button 
                          style={{color: '#000000', border: '1px solid #000000', height: '40px', backgroundColor: 'white'}}
                          className="w-100"
                          onClick={(e) => {
                            e.stopPropagation();
