...
const LoginRegister = () => {
  ...
  const handleFacebookLogin = () => {
    window.location.href = "https://looi-store-server-izvs.onrender.com/api/auth/facebook";
  };
                          ...
                          <div className="login-register-form">
                            ...
                            <form onSubmit={handleLoginSubmit} noValidate>
                              ...
                              <div className="password-input-wrapper mb-2" style={{ position: 'relative' }}>
                                ...
                                <button type="button" onClick={() => setShowLoginPassword(!showLoginPassword)} style={{ position: 'absolute', right: '12px', top: '25px', transform: 'translateY(-50%)', background: 'none', border: 'none', cursor: 'pointer', padding: '0', lineHeight: '1', display: 'flex', alignItems: 'center' }}>
                          ...
                          <div className="login-register-form">
                            ...
                            <form onSubmit={handleRegisterSubmit} noValidate>
                              ...
                              <div className="password-input-wrapper mb-2" style={{ position: 'relative' }}>
                                ...
                                <button type="button" onClick={() => setShowRegisterPassword(!showRegisterPassword)} style={{ position: 'absolute', right: '12px', top: '25px', transform: 'translateY(-50%)', background: 'none', border: 'none', cursor: 'pointer', padding: '0', lineHeight: '1', display: 'flex', alignItems: 'center' }}>
                              ...
                              <div className="password-input-wrapper mb-2" style={{ position: 'relative' }}>
                                ...
                                <button type="button" onClick={() => setShowRegisterConfirmPassword(!showRegisterConfirmPassword)} style={{ position: 'absolute', right: '12px', top: '25px', transform: 'translateY(-50%)', background: 'none', border: 'none', cursor: 'pointer', padding: '0', lineHeight: '1', display: 'flex', alignItems: 'center' }}>
